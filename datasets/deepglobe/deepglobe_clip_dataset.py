...
def parse_args():
    ...
    parser.add_argument('--dataset_path',default=r'D:\BaiduNetdiskDownload\DeepGlobe_Land\land-train',
...
def main():
    ...
    if args.out_dir is None:
        out_dir = osp.join(r'D:\BaiduNetdiskDownload\DeepGlobe_Land', f'deepglobe_{args.clip_size}_{args.stride_size}')
    else:
