...
class_list = ["imp surf","building","low vegetation","tree","car","background"]
...
def load_cls_label_list(name_list_dir):
    label_dict = np.load(os.path.join(name_list_dir, 'cls_labels_onehot_potsdam.npy'), allow_pickle=True).item()
    modified_dict = {}
...
class potsdamDataset(Dataset):
    def __init__(
        ...
        self.label_dir = os.path.join(root_dir, 'ann_dir', stage+'_new')
