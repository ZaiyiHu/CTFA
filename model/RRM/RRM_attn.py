...
import model.RRM.resnet38d as resnet
...
class Net(resnet.Net):
    def __init__(self):
        ...
        self.fc8 = nn.Conv2d(4096, 15, 1, bias=False)
        torch.nn.init.xavier_uniform_(self.fc8.weight)

        self.fc8_seg_conv1 = nn.Conv2d(4096, 512, 3, stride=1, padding=12, dilation=12, bias=True)
        torch.nn.init.xavier_uniform_(self.fc8_seg_conv1.weight)

        self.fc8_seg_conv2 = nn.Conv2d(512, 16, 3, stride=1, padding=12, dilation=12, bias=True)
        torch.nn.init.xavier_uniform_(self.fc8_seg_conv2.weight)

        self.GAU_w1 = nn.Conv2d(4096, 256, 1, bias=False)
        self.GAU_w2 = nn.Conv2d(4096, 256, 1, bias=False)
        self.GAU_w3 = nn.Conv2d(4096, 256, 1, bias=False)
        self.fc8_seg_conv3 = nn.Conv2d(512, 256, 3, stride=1, padding=1, dilation=1, bias=False)
        self.fc8_seg_conv4 = nn.Conv2d(256, 16, 3, stride=1, padding=1, dilation=1, bias=False)
